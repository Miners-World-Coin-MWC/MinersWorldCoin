...
void Shutdown()
{
    ...
    RenameThread("minersworldcoin-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/MinersWorldCoin-MWC/MinersWorldCoin>";
    const std::string URL_WEBSITE = "<https://minersworld.org>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("minersworldcoin-loadblk");
...
bool AppInitMain()
{
    ...
    if (gArgs.IsArgSet("-datadir") && !fs::path(gArgs.GetArg("-datadir", "")).is_absolute()) {
        LogPrintf("Warning: relative datadir option '%s' specified, which will be interpreted relative to the "
                  "current working directory '%s'. This is fragile, because if minersworldcoin is started in the future "
                  "from a different location, it will be unable to locate the current data files. There could "
                  "also be data loss if minersworldcoin is started while in a temporary directory.\n",
