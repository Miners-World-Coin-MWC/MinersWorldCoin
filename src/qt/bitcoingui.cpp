...
#include <boost/bind/placeholders.hpp> // For boost::placeholders::_1, etc.
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MinersWorldCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and minersworldcoin: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MinersWorldCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MinersWorldCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a minersworldcoin: URI or payment request"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible MinersWorldCoin command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        tooltip = tr("%n active connection(s) to MinersWorldCoin network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr("MinersWorldCoin"); // default title
    ...
    // Append title to "MinersWorldCoin - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
