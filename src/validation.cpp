...
#if defined(NDEBUG)
# error "MinersWorldCoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "MinersWorldCoin Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s MWC additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("minersworldcoin-scriptch");
        ...
        return state.DoS(100,
                         error("ConnectBlock(): coinbase pays too much (actual=%d vs limit=%d)",
                               ...
                               if (!IsValidDestination(destDeveloperFeeAddress)) {
                                   LogPrintf("IsValidDestination: Invalid MWC address %s \n", GetDeveloperFeeAddress);
                               }
